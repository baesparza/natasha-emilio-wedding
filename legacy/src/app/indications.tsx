export function Indications() {
    return <>
        <section className="fade-in-container ">
            <div className="relative z-10 mx-auto w-full max-w-2xl px-8 py-32">
            ...
            {/* assets */}
            <img className="z-0 absolute bottom-1/3 right-0 md:scale-125 origin-bottom-right" src="/flowers/thin-plant.png" alt="" />
        </section>
