export function ConfirmInvitation() {
    return <footer className="relative w-screen h-svh flex flex-col justify-center items-center gap-12">
        ...
        <button className="relative z-10 shadow-[0px_0px_5px_rgba(0,0,0,0.2)] text-black-light w-fit px-10 py-4 text-sm uppercase hover:bg-lavender hover:text-white  transition-colors duration-200">
            Confirma tu asistencia
        </button>

        {/* assets */}
        <img className="z-0 absolute left-0 bottom-0 w-1/2 md:w-1/3 lg:w-auto" src="/flowers/big-plant.png" alt="" />
